...
const scene = new WizardScene('airdrop',
    async (ctx) => {
        ...
        await ctx.reply(dedent`
            ...
            <b>SlimeToken (KAPPA)</b> 🌍: @SlimeTokeneng
            <b>SlimeToken</b> 🇷🇺: @SlimeTokenrus
    ...
    new Composer().hears('Check', async (ctx) => {
        ...
        await ctx.reply(dedent`
            2️⃣ Subscribe to our twitter <a href='https://twitter.com/Slime_Token'>@Slime_Token</a> and enter your twitter nickname to verify subscription 
    ...
    async (ctx) => {
        ...
        await ctx.reply('Enter your SlimeToken (KAPPA) wallet address')
    ...
    async (ctx) => {
        ...
        await ctx.reply(dedent`
            ...
            You registered successfully and you've received <b>250 000 000 SlimeToken (KAPPA)</b> for completing airdrop tasks.
            
            Also you can share your referral link and get <b>50 000 000 KAPPA</b> for each referral
            ...
            <i>DM to the @Ballet228 if you entered the wrong SlimeToken (KAPPA) wallet</i>
